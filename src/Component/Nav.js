  ...
  return (
      <div className='nav'>
          ...
          <ul>
              ...
              <li><Link style={{color : "black", textDecoration : "none"}} to="/kollywood" >Kollywood</Link></li>
      ...
      <button className='toogle__button' onClick={()=>toggle()}><i className="icon fa-solid fa-2x fa-bars"></i></button>
      </div>
    </div>
  )
}
